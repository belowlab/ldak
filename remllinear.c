...
int Xtotal=0, *Xstarts=NULL, *Xends=NULL, num_kins=1, num_regs=0, shortcut=1, memsave=-9999;
double *X=NULL, *Xsums=NULL, *V=NULL, *V2=NULL, *V3=NULL, *VZ=NULL, *VZZTVZ=NULL, *P=NULL, **mkins=NULL;
