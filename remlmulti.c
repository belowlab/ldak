...
void multi_reml(int ns, int num_covars, int num_envs, int num_tops, int num_kins, int num_regs, double *Y, double *Z, double **mkins, double *kintraces, double *kinsums, double *X, int Xtotal, int *Xstarts, int *Xends, double *Xsums, double prev, int np, int shortcut, double *U, double *E, int compact, int discenv, int liab, int constrain, double tol, int maxiter, int memsave, char **kinstems, char **ids3, char *outfile, char **ids1, char **ids2, int num_preds, char **allpreds, char *allal1, char *allal2, int *rkeeppreds, int **regindex, double *rcentres, double *rmults, double *rweights, int *tkeeppreds, double *tcentres, double *vstarts)
{
...
for(k=0;k<total;k++)
{
for(k2=0;k2<total;k2++){JAIJTsave[k+k2*total]=JAIJT[k+k2*total];}
}
